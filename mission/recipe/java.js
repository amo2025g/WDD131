...
const recipes = [
	...
	},
	{
		...
		image: 'https://wddbyui.github.io/wdd131/images/recipe1/apple-crisp.jpg',
		recipeIngredient: [
...
function displayRecipes(recipeList) {
	...
	if (recipeList.length === 0) {
		...
		recipeContainer.innerHTML = `
			<p class="no-results">Sorry, no recipes found.</p>`;
	...
	recipeList.forEach(recipe => {
		...
		recipeCard.innerHTML = `<div class="recipe-image">
			...
			<div class="recipe-content">
				...
				<p class="recipe-time">Prep: ${recipe.prepTime}Cook: ${recipe.cookTime}</p>
        <p class="recipe-yield">${recipe.recipeYield}</p></div>`;
